...
const AccountPreferences = () => {
  ...
  const [isBalanceLowerLimitCheckIcon, setIsBalanceLowerLimitCheckIcon] = useState(false);
  const [isMonthlyLimitCheckIcon, setIsMonthlyLimitCheckIcon] = useState(false);
  const [isTransactionAmountLimitCheckIcon, setIsTransactionAmountLimitCheckIcon] = useState(false);
    ...
    if (trueFalseValue != null && trueFalseValue == true) {
      ...
      return <View style={styles.rowMemberIcon} key={keyString}>
        <Icon
          ...
          size="sm"
          onPress={() =>
            Toast.success("The input is in correct format")
          } />
      </View>
    }
  }
              ...
              <>
                  ...
                  <View style={styles.rowMemberInput}>
                    ...
                    <InputItem
                      ...
                      onChange={(value) => {
                        ...
                        if (validateNumber(value, setErrors, setCheckIconsVisible, "balanceLowerLimit") == true)
                          setIsBalanceLowerLimitCheckIcon(true);
                        else
                          setIsBalanceLowerLimitCheckIcon(false);
                  ...
                  <View style={styles.rowMemberInput}>
                    ...
                    <InputItem
                      ...
                      onChange={(value) => {
                        ...
                        if (validateNumber(value, setErrors, setCheckIconsVisible, "monthlyLimit") == true)
                          setIsMonthlyLimitCheckIcon(true);
                        else
                          setIsMonthlyLimitCheckIcon(false);
                  ...
                  <View style={styles.rowMemberInput}>
                    <InputItem
                      ...
                      onChange={(value) => {
                        ...
                        if (validateNumber(value, setErrors, setCheckIconsVisible, "transactionAmountLimit") == true)
                          setIsTransactionAmountLimitCheckIcon(true);
                        else
                          setIsTransactionAmountLimitCheckIcon(false);
                ...
                <Button
                  ...
                  onPress={async () => {
                    ...
                    if (validateNumber(accountData.transactionAmountLimit.toString(), setErrors, setCheckIconsVisible, "transactionAmountLimit") == true &&
                      validateNumber(accountData.monthlyLimit.toString(), setErrors, setCheckIconsVisible, "monthlyLimit") == true &&
                      validateNumber(accountData.balanceLowerLimit.toString(), setErrors, setCheckIconsVisible, "balanceLowerLimit") == true) {
                      setLoading(true);
